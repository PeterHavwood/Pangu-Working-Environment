...
plot_surface_wind_temp(input_surface_ncfile_name, extent, t2m_levels, input_data_dir, figure_dir, 0)
...
if forecast_times > 1:
    ...
    for i in range(forecast_times):
        ...
        # Plot the results
        print("\n=== Ploting the figures ===")
        plot_surface_wind_temp(output_surface_ncfile_name, extent, t2m_levels, output_data_dir,figure_dir, single_forecast_hour*(i+1))
else:
    # Run the sessions
    ...
    # Plot the results
    print("\n=== Ploting the figures ===")
    plot_surface_wind_temp(output_surface_ncfile_name, extent, t2m_levels, output_data_dir,  figure_dir, single_forecast_hour)
